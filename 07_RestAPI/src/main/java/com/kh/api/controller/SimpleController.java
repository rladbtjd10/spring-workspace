...
@RestController //주소를 어떻게 설계 하느냐가 중요
...
public class SimpleController {
	 ...
	 * - 메서드의 리턴 타입으로 사용자가 정의한 클래스 타입도 사용할 수 잇고,
	...
	public Map<Integer, Person> sendGreet() {
		...
		map.put(1, new Person("김경미", "언능 끝났으면..!"));
		return map;
	}
