...
public class HelloFactory {
	...
	public synchronized static HelloFactory getInstance() { // Synchronized(동기화)-하나씩하나씩 처리하고자 할때 / 여러개의 스레드가 한개의 자원을 사용하고자 할 때, 현재 데이터를 사용하고 있는 해당 스레드를 제외하고 나머지 스레드들은 데이터에 접근 할 수 없도록 막는 개념입니다.
